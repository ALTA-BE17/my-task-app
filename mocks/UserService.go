...
func (_m *UserService) Deactive(userId uint) (user.Core, error) {
...
// GetAllUserHasBooks provides a mock function with given fields:
func (_m *UserService) GetAllUserHasBooks() ([]user.Core, error) {
	ret := _m.Called()
...
func (_m *UserService) Profile(userId uint) (user.Core, error) {
	ret := _m.Called(userId)
...
func (_m *UserService) SearchUsers(userId uint, pattern string) ([]user.Core, error) {
...
func (_m *UserService) UpdateProfile(userId uint, request user.Core) (user.Core, error) {
